...
Thankfully, you can mathematically know if two colors have enough contrast by adhering to the Mail Content Accessibility Guidelines ([WCAG](https://www.w3.org/TR/WCAG20/)). To get a passing grade (AA), the contrast ratio needs to be at least 4.5:1.
